...
import (
	...
	"github.com/the-protobuf-project/cache/examples/generated/gorm/gormx"
	"gorm.io/gorm"
)
...
// Shelf groups books physically. The resource's `plural` fixes the irregular plural ("shelfs" → "shelves") — no table name override needed. Deliberately unannotated in cache.v1: no (cache.v1.cache), so no decorator is generated for it and the inventory schema produces no cache package at all.
